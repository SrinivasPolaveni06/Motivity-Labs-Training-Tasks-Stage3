...
const Index = () => {
  ...
  function getGrocerysData() {
    axios
      .get(`http://localhost:3005/product/?search=Grocerys&order_by=${sortValue.price}&order=${sortValue.name}`)
      .then((res) => {
        console.log(res);
  ...
  return (
    ...
    //     </div>
        // <div className="col-9 ">
        <div>
          <h3 className="text-danger">Top Grocerys List:</h3>
