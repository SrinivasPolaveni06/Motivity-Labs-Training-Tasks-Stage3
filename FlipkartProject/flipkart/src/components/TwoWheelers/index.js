...
const Index = () => {
  ...
  function getGrocerysData() {
    axios
      .get(`http://localhost:3005/product/?search=Vechiles&order_by=${sortValue.price}&order=${sortValue.name}`)
      .then((res) => {
        console.log(res);
      ...
      <>
        ...
        <div className="row d-flex flex-wrap">
          {grocerysData.map((eachProduct) => (
            <div
              key={eachProduct._id}
              className="col-lg-3 product-card shadow m-3 p-2"
            >
              <img
  ...
  return (
    ...
    //     <div className="col-9 ">
    <div>
      <h3 className="text-danger">Top Vechiles List:</h3>
